      ...
      <div className="relative z-10 w-full mx-auto px-8 py-4 pl-8 md:pl-24 lg:pl-24 lg:pr-16 xl:pr-24">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-y-12 lg:gap-x-0 items-center w-full">
          ...
          <div className="lg:col-span-1 flex flex-col items-start w-full pr-0 lg:pr-8">
            ...
            <h2 className="font-display text-[36px] md:text-[46px] font-extralight tracking-[0.06em] uppercase text-foreground/95 leading-[1.15] mb-8 drop-shadow-[0_2px_8px_rgba(0,0,0,0.5)]" style={{ fontFamily: "'Antonio', sans-serif" }}>
              READY TO TELL <br />
              YOUR STORY?
            </h2>
            ...
            <a 
              ...
              className="inline-flex items-center gap-3 border border-[#c5a075]/40 hover:border-[#c5a075] bg-background/10 backdrop-blur-[1px] hover:bg-foreground/[0.02] transition-all duration-300 px-8 py-3.5 group select-none"
            >
              <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4 text-foreground/80 group-hover:text-[#c5a075] transition-colors">
          ...
          <div className="w-full lg:col-span-2 flex flex-col pt-1 lg:pl-16 xl:pl-20">
            <div className="w-full max-w-[460px] lg:ml-auto">
              ...
              <h3 className="font-display text-[24px] md:text-[30px] font-extralight tracking-[0.1em] uppercase text-foreground/95 mb-4 drop-shadow-[0_2px_8px_rgba(0,0,0,0.5)]" style={{ fontFamily: "'Antonio', sans-serif" }}>
                JOIN THE JOURNEY
              </h3>

              <p className="text-muted text-[13px] font-light leading-[1.8] tracking-wide mb-8 drop-shadow-[0_1px_4px_rgba(0,0,0,0.4)]">
              ...
              <div className="w-full min-h-[40px] flex items-center">
                {submitted ? (
                  ...
                  <form onSubmit={handleSubmit} className="w-full flex items-center border-b border-divider bg-transparent pb-2.5 group focus-within:border-[#c5a075]/85 transition-colors duration-300">
                    <input
                      type="email"
                      required
                      value={email}
                      ...
                      className="bg-transparent border-none outline-none text-[13px] font-light tracking-wide w-full text-foreground/90 placeholder-foreground/25 focus:ring-0 p-0"
                    />
                    <button
                      type="submit"
