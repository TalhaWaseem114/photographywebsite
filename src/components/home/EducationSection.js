...
export default function EducationSection() {
  return (
    <section id="education-section" className="relative min-h-[600px] w-full grid grid-cols-1 md:grid-cols-2 bg-black border-t border-white/5">
      ...
      <div className="relative z-10 flex flex-col justify-center px-8 py-16 md:pl-8 md:pr-24 lg:pl-16">
        ...
        <h2 className="font-display text-[clamp(2.2rem,3.8vw,3.8rem)] leading-[1.05] tracking-[0.04em] uppercase mb-4 text-white font-light">
          Islamia University<br />of Bahawalpur
        </h2>

        {/* Timeline Range */}
        <div className="flex items-center gap-3 mb-8">
          <span className="font-condensed font-light text-[12px] tracking-[0.25em] text-white/40">
            2023
          </span>
        ...
        <div className="mb-8 flex flex-col gap-1 select-none">
          <h3 className="font-condensed font-medium text-[13px] tracking-[0.18em] uppercase text-white/90">
        ...
        <p className="text-[13px] leading-[2.1] text-white/50 max-w-[420px] font-light tracking-wide">
