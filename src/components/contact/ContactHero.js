    ...
    >
      ...
      <div className="relative z-10 max-w-[1700px] mx-auto px-8 pl-8 md:pl-28 lg:pl-32 lg:pr-16 xl:pr-24 w-full text-left">
        <div className="max-w-[750px]">
          ...
          <p className="text-white/60 text-[13px] sm:text-[14px] leading-[2] max-w-[480px] font-light tracking-wide">
            Whether <strong className="font-semibold text-white">booking a session</strong>, discussing a <strong className="font-semibold text-white">brand project</strong>, or asking a quick question, I would love to <strong className="font-semibold text-white">hear from you</strong>.
          </p>
        </div>
      </div>
