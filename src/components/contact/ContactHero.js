    ...
    >
      ...
      <div className="absolute inset-0 z-0 pointer-events-none">
        ...
        <div 
          ...
          style={{ 
            backgroundImage: 'url("/images/contactBg.png"), url("/images/heroFlower.png")',
      ...
      <div className="relative z-10 max-w-[1700px] mx-auto px-8 pl-8 md:pl-28 lg:pl-32 lg:pr-16 xl:pr-24 w-full text-left">
        <div className="max-w-[750px]">
          ...
          <h1
            className="font-display uppercase text-white mb-6 leading-none tracking-[0.15em]"
            style={{
          ...
          <p className="text-white/40 text-[13px] sm:text-[14px] leading-[2] max-w-[480px] font-light tracking-wide">
            Whether booking a session, discussing a brand project, or asking a quick question, I would love to hear from you.
          </p>
        </div>
      </div>
    </section>
