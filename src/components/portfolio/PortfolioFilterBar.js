...
export default function PortfolioFilterBar({ 
  ...
  return (
    <div className="sticky top-0 z-40 w-full bg-[rgba(8,8,8,0.85)] backdrop-blur-xl border-b border-white/5 shadow-lg shadow-black/30">
      ...
      <div className="max-w-[1700px] mx-auto px-6 md:px-16 lg:px-24 py-4 sm:py-5 flex items-center justify-between gap-6 overflow-x-auto no-scrollbar">
            ...
            return (
              <button
                ...
                className={`shrink-0 flex items-center gap-1.5 px-4 sm:px-5 py-2 rounded-full font-condensed text-[10px] tracking-[0.2em] uppercase transition-all duration-500 cursor-pointer focus:outline-none border
                  ${isActive
                    ? "bg-[var(--accent)] text-[#080808] border-[var(--accent)] font-semibold shadow-[0_0_15px_rgba(200,169,126,0.3)] scale-[1.02]"
