...
export default function TestimonialsHero({ totalCount = 9 }) {
  return (
    <section 
    ...
    >
      ...
      <div className="absolute inset-0 z-0 pointer-events-none">
        ...
        {/* Parallax Background */}
        <div 
          className="absolute inset-0 opacity-[0.2] mix-blend-screen bg-cover bg-center bg-no-repeat transition-all duration-700"
          style={{ 
            backgroundImage: 'url("/images/testimonialsBg.png"), url("/images/aboutTexture.png")',
      ...
      <div className="relative z-10 max-w-[1700px] mx-auto px-8 pl-8 md:pl-28 lg:pl-32 lg:pr-16 xl:pr-24 w-full text-left">
        <div className="max-w-[750px]">
          ...
          <p className="text-white/40 text-[13px] sm:text-[14px] leading-[2] mb-8 max-w-[480px] font-light tracking-wide">
            Collected reflections and kind testimonials from past creative commissions, weddings, spatial documentation, and gallery exhibitions.
          </p>
          ...
          <div className="flex flex-wrap gap-8 pt-6 border-t border-white/5 font-display text-white/50 tracking-widest text-[11px]">
            <div className="flex items-center gap-2">
              ...
              <span className="uppercase text-white/35 font-light">Client Ratings:</span>
              <span className="text-white font-semibold">5.0 / 5.0 Rating</span>
            </div>
            <div className="flex items-center gap-2">
              <span className="text-white font-medium">02 //</span>
              <span className="uppercase text-white/35 font-light">Total Reviews:</span>
              <span className="text-white font-semibold">{totalCount} Stories</span>
            </div>
            <div className="flex items-center gap-2">
              <span className="text-white font-medium">03 //</span>
              <span className="uppercase text-white/35 font-light">Clients:</span>
              <span className="text-white font-semibold">Brands & Individuals</span>
            </div>
          </div>
        </div>
      </div>
