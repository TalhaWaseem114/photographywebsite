...
export default function JournalHero({ essayCount = 2, logCount = 4 }) {
  return (
    <section 
      ...
      <div className="relative z-10 max-w-[1700px] mx-auto px-8 pl-8 md:pl-28 lg:pl-32 lg:pr-16 xl:pr-24 w-full text-left">
        <div className="max-w-[750px]">
          ...
          <p className="text-white/60 text-[13px] sm:text-[14px] leading-[2] mb-8 max-w-[480px] font-light tracking-wide">
            Behind the frame. A collection of <strong className="font-semibold text-white">photographic journeys</strong>, <strong className="font-semibold text-white">field notes</strong>, and daily light logs compiled during editorial and personal projects.
          </p>
          ...
          <div className="flex flex-wrap gap-8 pt-6 border-t border-white/5 font-display text-white/50 tracking-widest text-[11px]">
            <div className="flex items-center gap-2">
              ...
              <span className="uppercase text-white/35 font-light">Photo Essays:</span>
              <span className="text-white font-semibold">{essayCount}</span>
            </div>
            <div className="flex items-center gap-2">
              <span className="text-white font-medium">02 //</span>
              <span className="uppercase text-white/35 font-light">Daily Logs:</span>
              <span className="text-white font-semibold">{logCount}</span>
            </div>
            <div className="flex items-center gap-2">
              <span className="text-white font-medium">03 //</span>
              <span className="uppercase text-white/35 font-light">Archive Vol:</span>
